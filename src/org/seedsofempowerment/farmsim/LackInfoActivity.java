...
* description : When the lacks some information to start the game, it will pop up a new window
* 
...
//This activity is called if the user doesn't input enough information
